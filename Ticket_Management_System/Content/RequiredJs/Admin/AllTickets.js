...
var filterFormEl = document.getElementById('adminFilterForm');
var searchVal   = filterFormEl ? (filterFormEl.dataset.search || '') : '';
var dateVal     = filterFormEl ? (filterFormEl.dataset.date || '') : '';
var sortVal     = filterFormEl ? (filterFormEl.dataset.sortOrder || 'newest') : 'newest';
var assignedVal = filterFormEl ? (filterFormEl.dataset.assigned || '') : '';
var viewVal     = filterFormEl ? (filterFormEl.dataset.view || 'unassigned') : 'unassigned';
