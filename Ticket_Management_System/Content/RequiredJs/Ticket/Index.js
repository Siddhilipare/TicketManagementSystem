...
var filterFormEl = document.getElementById('ticketFilterForm');
...
var statusVal   = filterFormEl ? (filterFormEl.dataset.statusFilter || '') : '';
...
function openDeleteModal(id, title, status, date) {
    ...
    var ticketIdEl = document.getElementById('deleteTicketId');
    if (ticketIdEl) ticketIdEl.value = id;
    var deleteForm = document.getElementById('deleteForm');
    if (deleteForm) deleteForm.action = '/Ticket/Delete/' + id;
    saveState();
